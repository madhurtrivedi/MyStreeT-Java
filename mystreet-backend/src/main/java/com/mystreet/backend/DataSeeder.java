    ...
    public void run(String... args) {
        ...
        List<Product> products = List.of(
                Product.builder().name("Air Max 90").brand("Nike")
                        ...
                        .imageUrl("https://picsum.photos/seed/airmax90/400/300")
                ...
                Product.builder().name("Ultraboost 22").brand("Adidas")
                        ...
                        .imageUrl("https://picsum.photos/seed/ultraboost/400/300")
                ...
                Product.builder().name("Chuck Taylor All Star").brand("Converse")
                        ...
                        .imageUrl("https://picsum.photos/seed/chucktaylor/400/300")
                ...
                Product.builder().name("Old Skool").brand("Vans")
                        ...
                        .imageUrl("https://picsum.photos/seed/oldskool/400/300")
                ...
                Product.builder().name("RS-X3").brand("Puma")
                        ...
                        .imageUrl("https://picsum.photos/seed/rsx3/400/300")
                ...
                Product.builder().name("Air Force 1").brand("Nike")
                        ...
                        .imageUrl("https://picsum.photos/seed/airforce1/400/300")
                ...
                Product.builder().name("Stan Smith").brand("Adidas")
                        ...
                        .imageUrl("https://picsum.photos/seed/stansmith/400/300")
                ...
                Product.builder().name("Classic Leather").brand("Reebok")
                        ...
                        .imageUrl("https://picsum.photos/seed/classicleather/400/300")
